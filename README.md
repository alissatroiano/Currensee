...
- [Tests](c:/docs/tests/tests.md)
    - [Creating MindsDB Models](c:/docs/tests/tests.md#creating-mindsdb-models)
    - [Testing MindsDB Models](c:/docs/tests/tests.md#testing-mindsdb-models)
    - [Testing the App](c:/docs/tests/tests.md#testing-the-app)
