...
export default abstract class TablesApiClient {
     ...
     */
    abstract createTable(name: string, integration: string, select: string): Promise<Table>;
    /**
     ...
     */
    abstract createOrReplaceTable(name: string, integration: string, select: string): Promise<Table>;
    /**
